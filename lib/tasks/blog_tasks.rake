...
namespace :blog do
  ...
  task :seed => :environment do
    ...
    if I18n.default_locale == 'en-RC'.to_sym
      ...
      setting = Blog::Setting.create(:key => "global:website_title", :value => "ResumeGenius Blog", :description => "This will be your website name")
      setting = Blog::Setting.create(:key => "global:meta_title", :value => "ResumeGenius Blog", :description => "This is default title if we can't find tilte")
      setting = Blog::Setting.create(:key => "global:meta_description", :value => "ResumeGenius Blog", :description => "This is default meta description if we can't find meta description")
      setting = Blog::Setting.create(:key => "global:meta_keywords", :value => "ResumeGenius Blog", :description => "This is default meta description if we can't find meta description")
      setting = Blog::Setting.create(:key => "global:posts:sidebar_id", :value => 1, :description => "This will be your posts' sidebar id")
      setting = Blog::Setting.create(:key => "global:tags:sidebar_id", :value => 1, :description => "This will be your tags' sidebar id")
      setting = Blog::Setting.create(:key => "global:disqus:shortname", :value => "resumebuilder1", :description => "This is for disqus")
      setting = Blog::Setting.create(:key => "global:ga_account", :value => "UA-513849-6", :description => "This is GA account")
      setting = Blog::Setting.create(:key => "global:theme", :value => "resumegenius", :description => "This is theme setting")
      ...
      <div>
        <h3>Resume For Beginners!</h3>
        <ul>
          <li><a href="http://resumegenius.com" title="Resume 101">Resume 101</a></li>
          <li><a href="http://resumegenius.com" title="Resume 102">Resume 102</a></li>
          <li><a href="http://resumegenius.com" title="How to write your resume">How to write your resume</a></li>
        </ul>
      </div>'
